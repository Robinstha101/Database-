<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TourGuideDetails.aspx.cs" Inherits="Database_CW.TourGuideDetails" %>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#mapping">Tour Guide Details</a>
                </li>
                <li class="nav-item">
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="mapping">
      <div class="w-100">
        <h2 class="mb-5">Tour Guide Details</h2>
    <form id="form1" runat="server">
        <div>
            <asp:FormView ID="FormView1" runat="server" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataSourceID="SqlDataSource1" DefaultMode="Insert" DataKeyNames="STAFF_ID">
                <EditItemTemplate>
                    STAFF_NAME:
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" DataKeyNames="STAFF_ID">
                <Columns>
                    ...
                    <asp:BoundField DataField="STAFF_ID" HeaderText="STAFF_ID" ReadOnly="True" SortExpression="STAFF_ID"></asp:BoundField>
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT STAFF.STAFF_NAME, STAFF.STAFF_ADDRESS, STAFF.STAFF_CONTACT, &quot;ROLE&quot;.ROLE_NAME, STAFF.STAFF_ID FROM STAFF, &quot;ROLE&quot; WHERE STAFF.ROLE_ID = &quot;ROLE&quot;.ROLE_ID AND (&quot;ROLE&quot;.ROLE_NAME = 'Tour Guide')"></asp:SqlDataSource>
        </div>
    </form>
           </div>
    </section>
